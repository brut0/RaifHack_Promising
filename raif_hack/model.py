...
class BenchmarkModel():
    ...
    def fit(self, X_offer: pd.DataFrame, y_offer: pd.Series,
        ...
        self.pipeline.fit(X_offer, y_offer, model__feature_name=[f'{i}' for i in range(
            len(NUM_FEATURES + CATEGORICAL_OHE_FEATURES + CATEGORICAL_STE_FEATURES))],
                          model__categorical_feature=[f'{i}' for i in
                                                      range(len(NUM_FEATURES + CATEGORICAL_OHE_FEATURES),
                                                            len(NUM_FEATURES + CATEGORICAL_OHE_FEATURES + CATEGORICAL_STE_FEATURES))])
